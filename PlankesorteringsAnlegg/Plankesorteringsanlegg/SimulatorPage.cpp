/*
 *
 * This is an altered version of Erin Cattos Box2D 2.2.1 Testbed Test.cpp
 *
 * */
...
{
	if (simulatorPage->m_mouseJoint == joint)
	{
		simulatorPage->m_mouseJoint = NULL;
	}
	else
	{
		simulatorPage->JointDestroyed(joint);
	}
}

SimulatorPage::SimulatorPage(Communicator* communicator)
{
	...
	m_destructionListener.simulatorPage = this;
