...
#ifndef PLANKESORTERINGSANLEGG_H_
#define PLANKESORTERINGSANLEGG_H_
...
{
public:
	Plankesorteringsanlegg(Communicator* communicator):SimulatorPage(communicator){
	...
	{
		return new Plankesorteringsanlegg(communicator);
	}
